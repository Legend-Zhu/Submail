    ...
    public class HttpWebHelper
    {
        ...
        public string GetTimeStamp()
        {
            using (HttpClient httpClient = new HttpClient())
            {
                using (HttpResponseMessage response = httpClient.GetAsync(API_TIMESTAMP).Result)
                {
                    ...
                    Dictionary<string, long> jsonMap = JsonSerializer.Deserialize<Dictionary<string, long>>(jsonResult);
        ...
        private MultipartFormDataContent Build(Dictionary<string, object> dataPair)
        {
            ...
            try
            {
                ...
                Dictionary<string, string> jsonMap = JsonSerializer.Deserialize<Dictionary<string, string>>(json);
